...
**EXACT: baseline 8/30 -> decompose 24/30.** gains=['I.6.20a', 'I.6.20', 'I.8.14', 'I.10.7', 'I.11.19', 'I.12.2', 'I.12.4', 'I.15.3t', 'I.16.6', 'I.24.6', 'I.32.5', 'I.34.8', 'I.39.22', 'I.43.31', 'I.43.43', 'I.48.2'], losses=[]. Wall-clock 668s.
...
| I.8.14 | `sqrt((x2-x1)^2+(y2-y1)^2)` | fail (0.03) | exact (5e-31) | `peel[square]->base` |
| I.9.18 | `G*m1*m2/((x2-x1)^2+(y2-y1)^2+(` | fail (0.06) | approx (3e-05) | `peel[square]->peel[log_abs]->base` |
...
| I.12.2 | `q1*q2/(4*pi*eps*r^2)` | fail (0.02) | exact (3e-30) | `peel[square]->powerlaw` |
| I.12.4 | `q1*q2/(4*pi*eps*r^2)` | fail (0.04) | exact (2e-30) | `peel[square]->powerlaw` |
...
| I.14.4 | `0.5*k*x^2` | exact (3e-31) | exact (1e-31) | `base` |
| I.15.3t | `(x-u*t)/sqrt(1-u^2/c^2)` | approx (9e-05) | exact (2e-10) | `base` |
| I.16.6 | `(u+v)/(1+u*v/c^2)` | approx (0.0001) | exact (8e-10) | `base` |
| I.18.4 | `(m1*r1+m2*r2)/(m1+m2)` | approx (0.002) | approx (0.001) | `peel[square]->peel[square]->base` |
| I.24.6 | `0.5*m*(omega^2+omega0^2)*x^2` | fail (0.02) | exact (6e-31) | `base` |
...
| I.32.5 | `q^2*a^2/(6*pi*eps*c^3)` | fail (0.06) | exact (5e-28) | `peel[square]->peel[log_abs]->base` |
| I.34.8 | `q*v*B/p` | fail (0.05) | exact (3e-32) | `peel[square]->powerlaw` |
| I.39.22 | `n*k*T/V` | fail (0.05) | exact (3e-32) | `peel[square]->powerlaw` |
| I.40.1 | `n0*exp(-m*g*x/(k*T))` | fail (0.05) | fail (0.01) | `peel[sqrt_abs]->peel[square]->base` |
| I.43.31 | `k*T/(6*pi*eta*r)` | fail (0.02) | exact (5e-30) | `peel[square]->powerlaw` |
